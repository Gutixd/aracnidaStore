...
export function Footer() {
  return (
    <footer style={{ background: '#1a2744', color: 'rgba(255,255,255,.6)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed max-w-xs" style={{ color: 'rgba(255,255,255,.45)' }}>
              Disfraces y máscaras Spider-Man de calidad premium. Envíos a todo Chile.
            </p>
            ...
            <div className="flex items-center gap-3 mt-5">
              ...
              <a href="https://wa.me/56978829942" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-xl flex items-center justify-center transition-all hover:scale-110"
                style={{ background: 'rgba(255,255,255,.08)' }}>
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" style={{ color: 'rgba(255,255,255,.6)' }}>
          ...
          {/* Links */}
          <div>
            <h4 className="text-sm font-bold text-white mb-4 uppercase tracking-wider">Tienda</h4>
